                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{url('informasi/post')}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{$a->nama}}" class="form-control" id="exampleInputName1" placeholder="Nama Instansi" name="nama" disabled="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Telepon</label>
                      <input type="number" value="{{$a->telepon}}" class="form-control" id="exampleInputEmail3" placeholder="Telepon" name="telepon" disabled="" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Kode Pos</label>
                      <input type="number" value="{{$a->kodepos}}" class="form-control" id="exampleInputPassword4" placeholder="Kode Pos" name="kodepos" disabled="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Deskripsi</label>
                      <textarea id="exampleInputPassword4" class="form-control" placeholder="Deskripsi" name="deskripsi" disabled="">{{$a->deskripsi}}</textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Alamat</label>
                      <textarea id="exampleInputPassword4" class="form-control" name="alamat" placeholder="Alamat" disabled="">{{$a->alamat}}</textarea>
                    </div>
                    @endforeach
                  </form>
                </div>
